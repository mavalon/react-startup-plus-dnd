...
/******/ 	__webpack_require__.p = "C:\\Avalon\\apps\\react-dnd/example";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = function (_React$Component) {
	  ...
	  function Component(props) {
	    ...
	    _this.unobserve = (0, _Game.observe)(_this.handleChange.bind(_this));
	    return _this;
	  }
	
	  _createClass(Component, [{
	    key: 'handleChange',
	    value: function handleChange(knightPosition) {
	      var nextState = { knightPosition: knightPosition };
	    ...
	    value: function render() {
	      var knightPosition = this.state.knightPosition;
	
	
	      if (this.props.onRender) {
	        this.props.onRender();
	      }
	      return _react2.default.createElement(_Board2.default, { size: '800px', knightPosition: knightPosition });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Knight = __webpack_require__(162);
